					...
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" id="addStudent">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select type="text" id="student_sex" placeholder="输入性别"
										class=" col-xs-10 col-sm-5" style="list-style:none;padding:0;margin:0;">
							...
							<div class="form-group">
								...
								<div class="col-sm-9" >
									<select type="text" id="student_buildingName" placeholder="输入楼名称"
										class=" col-xs-10 col-sm-5 student_buildingName" style="list-style:none;padding:0;margin:0;">
								    </select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select type="text" id="student_dormitoryName" placeholder="输入宿舍名称"
										class=" col-xs-10 col-sm-5 student_dormitoryName" style="list-style:none;padding:0;margin:0;">
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select type="text" id="student_bedName" placeholder="输入床位名称"
										class=" col-xs-10 col-sm-5 student_bedName" style="list-style:none;padding:0;margin:0;">
								    </select>
								</div>
							</div>
