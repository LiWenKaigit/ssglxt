				...
				<div class="modal-body">
					<form action="">
						...
						<div style="width: 80%; margin: auto;" class="panel-body">
										...
										id="updatestudent_sex"	name="student.student_sex" type="text">
...
<%-- 										id="updatestudent_checkIn_time"	name="student.student_checkIn_time" type="text"></span> --%>
							<div class="col-sm-9 " style="float:left;margin:0 0 0 10px;">
								<input type="text" id="laydateInput" name="student.student_checkIn_time" />
	...
	<script type="text/javascript" src="js/Admin/page_list_student.js"></script>
