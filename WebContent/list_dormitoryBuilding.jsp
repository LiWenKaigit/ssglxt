				...
				<div class="modal-body">
					<form action="">
						...
						<div style="width: 80%; margin: auto;" class="panel-body">
										...
										<span style="float:left;margin:0 0 0 38px;"><select style="width: 300%;" class="form-control"
											name="dormitoryBuilding.dormitoryBuilding_liveSex" type="text">
				...
				<div class="modal-body">
					<form action="">
						...
						<div style="width: 80%; margin: auto;" class="panel-body">
										<span style="float:left;margin:0 0 0 0;line-height:34px;">居住性别</span>
										<span style="float:left;margin:0 0 0 38px;"><select style="width: 300%;" class="form-control"
										id="updatedormitoryBuilding_liveSex"	name="dormitoryBuilding.dormitoryBuilding_liveSex" type="text">
										<option value="男">男</option>
										<option value="女">女</option>
										</select>
										</span>
