...
<body>
		...
		<div class="breadcrumbs" id="breadcrumbs" style="margin-left: 190px;">
			<ul class="breadcrumb">
				<li style="color:#4c8fbd;"><i class="ace-icon fa fa-home home-icon"></i>
					宿舍信息管理</li>
				<li style="color:#4c8fbd;">宿舍房间管理</li>
			</ul>
			<!-- /.breadcrumb -->
            
									<button class="btn  btn-minier btn-white btn-info btn-bold " data-toggle="modal" data-target="#addDormitory" >
										<i class="fa fa-plus-square"></i> 添加宿舍房间
									</button>
									
									<button style="margin-left:20px;" class="btn btn-minier btn-white btn-warning btn-bold " data-toggle="modal" onclick="deleteDormitory()" >
		...
		<div class="modal-dialog modal-lg" style="width:500px;">
			<div class="modal-content">
				<div class="modal-header widget-header">
					...
					<h4 class="modal-title" id="modal-title">添加宿舍房间</h4>
				</div>
				<div class="modal-body">
					<form action="">
						<div style="width: 80%; margin: auto;" class="panel-body">
										<span style="float:left;margin:0 0 0 0;line-height:34px;">楼名称</span>
										<span style="float:left;margin:0 0 0 50px;width: 159px;"><select style="width: 300%;" class="form-control selectpicker" 
											name="dormitory.dormitory_buildingName" type="text">
											</select>
											</span>
										<input type="hidden"  >
						</div>
						...
						<div style="width: 80%; margin: auto;" class="panel-body">
										...
										<span style="float:left;margin:0 0 0 38px;"><input style="witdh: 80%;" class="form-control"
											name="dormitory.dormitory_name" type="text"></span>
										<input type="hidden"  >
						</div>
						
						<div style="width: 80%; margin: auto;" class="panel-body">
										<span style="float:left;margin:0 0 0 0;line-height:34px;">宿舍规模</span>
										<span style="float:left;margin:0 0 0 38px;"><input style="witdh: 80%;" class="form-control"
											name="dormitory.dormitory_scale" type="text"></span>
										<input type="hidden"  >
						</div>
					</form>
				</div>
	...
	<!-------------------------------------------修改宿舍房间的模态框--------------------------------------------------------->
	<div class="modal fade" id="updateDormitory" tabindex="-1"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" style="width:500px;">
			<div class="modal-content">
				<div class="modal-header widget-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="modal-title">修改宿舍房间信息</h4>
				</div>
				<div class="modal-body">
					<form action="">
						<div style="width: 80%; margin: auto;" class="panel-body">
										<span style="float:left;margin:0 0 0 0;line-height:34px;">楼名称</span>
										<span style="float:left;margin:0 0 0 50px;width: 159px;background-color:#393939;" ><select class="form-control selectpicker " 
										id="updatedormitory_buildingName"	name="dormitory.dormitory_buildingName" type="text">
									
										</select>
										</span>
										<input type="hidden"  name="dormitory.dormitory_id" id ="updatedormitory_id">
						</div>
						
						<div style="width: 80%; margin: auto;" class="panel-body">
										<span style="float:left;margin:0 0 0 0;line-height:34px;">宿舍名称</span>
										<span style="float:left;margin:0 0 0 38px;"><input style="witdh: 80%;" class="form-control"
										id="updatedormitory_name"	name="dormitory.dormitory_name" type="text"></span>
						</div>
						
						<div style="width: 80%; margin: auto;" class="panel-body">
										<span style="float:left;margin:0 0 0 0;line-height:34px;">宿舍规模</span>
										<span style="float:left;margin:0 0 0 38px;"><input style="witdh: 80%;" class="form-control"
										id="updatedormitory_scale"	name="dormitory.dormitory_scale" type="text"></span>
						</div>
					</form>
				</div>
				<div class="modal-footer">
	...
	<script type="text/javascript" src="js/superAdmin/page_list_dormitory.js"></script>
</body>
</html>